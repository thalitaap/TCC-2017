...
?>
<html lang="en">
<!-- SITE SEM NOME DE RPG - V1.2 - Pág. personalizar
    ...
    <!-- Fim do trecho para botão menu mobile -->
     ...
     <div class="collapse navbar-collapse" id="menuprincipal"> <!-- menu 04 -->
      <ul class="nav navbar-nav menu-itens navbar-btn"> <!-- lista menu -->
        ...
        <li class="active"><a href="personalizar.php">Personalizar</a></li>
    </ul><!-- fim lista menu -->
...
<!-- Central -->
    ...
    <br><br><br>Em breve...
    <!-- Substituir abaixo pelos itens de personalização -->
    <!-- <iframe src="##" id="##" scrolling="no"></iframe> --> 
