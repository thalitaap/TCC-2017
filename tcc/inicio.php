...
?>
<html lang="en">
<!-- SITE SEM NOME DE RPG - V1.2 - Pág. início
...
<!-- Carousel --> 
<br><br>
    <div id="info_carousel" class="carousel slide" data-ride="carousel"> <!-- carousel 00 -->
    ...
    <!-- Wrapper for slides/ itens dentro dos slides -->
    <div class="carousel-inner"> <!-- carousel 01 -->
      <div class="item active"> <!-- carousel 02 -->
        <img src="images/carousel01.png" alt="Banner 1" style="width:100%;">
      </div> <!-- fim carousel 02 -->

      <div class="item"> <!-- carousel 03 -->
        <img src="images/carousel02.png" alt="Banner 2" style="width:100%;">
      </div> <!-- fim carousel 03 -->
    
      <div class="item"> <!-- carousel 04 -->
        <img src="images/carousel03.png" alt="Banner 3" style="width:100%;">
      </div> <!-- fim carousel 04 -->
    </div><!-- fim carousel 01 -->
    </div><!-- fim carousel 00 -->
<!-- Fim do Carousel -->
	<p class="texto-centro"> Olá jogador! Seja bem vindo a um mundo onde programação e diversão andam juntos! Não perca tempo, 
navegue pelo menu para descobrir tudo o que você pode encontrar pelo website. Quanto mais jogar mais aprenderá! ;-) </p>
